...
namespace Hamster
{
    ...
    public:
        ...
        //void SetMaterial(Ref<Material> _material) { material = _material; }

        // Draw the mesh. Inherited from IDrawable
        //virtual void OnDraw(RenderTarget2D& _target, const glm::mat4& parentTransform = glm::mat4(1.f)) override;
